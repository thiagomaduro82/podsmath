...
<div class="content-header">
	<div class="container-fluid">
		<div class="row justify-content-center m-0 p-0">
			...
			<h3 class="m-0 text-maroon"><i class="nav-icon fas fa-user-friends mr-3"></i>Usuários</h3>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
</div>
					...
					<div class="col-md-6 col-sm-12">
						...
						<div class="float-right">
							<form id="frm" class="form-inline my-2 my-lg-0" method="post">
								...
								<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Nome ou E-mail" aria-label="Search" name="txtbuscar" id="txtbuscar">
