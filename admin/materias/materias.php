					...
					<div class="col-md-6 col-sm-12">
						...
						<div class="float-right">
							<form id="frm" class="form-inline my-2 my-lg-0" method="post">
								...
								<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="nome ou nome menu" aria-label="Search" name="txtbuscar" id="txtbuscar">
					...
					<div class="modal-header p-2">
						<h5 class="modal-title text-primary" id="exampleModalLabel">
							<?php if(@$_GET['funcao'] == 'editar'){
								...
								$res = $pdo->query("select * from materias where id = '$id_reg'");
								$dados = $res->fetchAll(PDO::FETCH_ASSOC);
								$nome = $dados[0]['nome'];
								$nomemenu = $dados[0]['nomemenu'];
								echo 'Edição de Matérias';
							}else{
								$nome_botao = 'Salvar';
								echo 'Cadastro de Matérias';
							} ?>
						</h5>
					</div>
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nomemenu" name="nomemenu" value="<?php echo @$nomemenu ?>" required>
									</div>
								</div>
							</div>
