<img src="site/img/imagem-inicial.jpeg" alt="">
<div class="row justify-content-center mt-4">
    <div class="col-md-5 col-ms-12 text-center mt-4">
        <div class="card " style="width: 100%; height: 100%;">
            <h3 class="card-title p-3 ">QUEM SOMOS ?</h3>
    ...
    <div class="col-md-5 col-ms-12 text-center mt-4">
        <div class="card " style="width: 100%; height: 100%;">
            <h3 class="card-title p-3 ">INTRODUÇÃO</h3>
            <div class="card-body p-3 ">
                <h1><i class="fa fa-play-circle-o fa-5x text-primary" aria-hidden="true"></i></h1>
                <br/>
